...
enum TokenType {
	...
	TOKEN_INCREMENT, TOKEN_DECREMENT, TOKEN_DOUBLE_COLON,
	// Literals.
	...
	TOKEN_TRUE, TOKEN_VAR, TOKEN_WHILE, TOKEN_SWITCH, TOKEN_FOREACH, 
	TOKEN_BREAK, TOKEN_CASE, TOKEN_DEFAULT, TOKEN_CONTINUE,
